            ...
            <form id="yakutlogin-admin-form">
                ...
                <div id="woocommerce-content" class="content-section">
                    <div class="section-header">
                        ...
                        <p>فرم ورود پیامکی را جایگزین فرم پیش‌فرض ووکامرس در صفحه تسویه حساب کنید.</p>
                    </div>
                    <div class="settings-grid">
